    ...
    def login_page(self, new_account: bool):
        ...
        if new_account == False: # If user is not creating a new account.
            ...
            if new_account:  # If user is creating account.
                ...
                elif not username.isalnum(): # If username has symbols.
                    messagebox.showerror(title="Error", message="Username cannot have symbols.") # Display error message saying username cannot have symbols.
...
class Difficulty():
    ...
    def set_difficulty(self, difficulty):
        ...
        Returns: None
        """
        main(difficulty) # Call on the function to create the math game.
...
def main(difficulty): 
    ...
    def restart_game():
        ...
        main(difficulty)  # Start the game again with the selected difficulty
